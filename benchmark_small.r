...
col_names <- c("n_rows", "n_cols", "NA_count", "time_user", "time_system", "time_total", "n_cores")
...
header("write imputation timings")
saveRDS(timings_imputation, "timings_imputation.rds")

header("distances & permutation tests")
